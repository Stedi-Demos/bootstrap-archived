...
export class Convert {
    public static toBucketNotificationEvent(json: string): BucketNotificationEvent {
        return cast(JSON.parse(json), r("BucketNotificationEvent"));
    }

    public static bucketNotificationEventToJson(value: BucketNotificationEvent): string {
