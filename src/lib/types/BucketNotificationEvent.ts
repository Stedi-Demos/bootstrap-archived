// https://quicktype.io/typescript generated type for incoming Bucket notification events
// To parse this data:
//
//   import { Convert, BucketNotificationEvent } from "./file";
//
//   const bucketNotificationEvent = Convert.toBucketNotificationEvent(json);
//
...
export class Convert {
  public static toBucketNotificationEvent(
    json: string
  ): BucketNotificationEvent {
    return cast(JSON.parse(json), r("BucketNotificationEvent"));
  }

  public static bucketNotificationEventToJson(
    value: BucketNotificationEvent
  ): string {
    return JSON.stringify(uncast(value, r("BucketNotificationEvent")), null, 2);
  }
}
  ...
  Record: o(
    [
      ...
      { json: "userIdentity", js: "userIdentity", typ: r("ErIdentity") },
      {
        ...
        js: "requestParameters",
        typ: r("RequestParameters"),
      },
      {
        json: "responseElements",
        js: "responseElements",
        typ: r("ResponseElements"),
      },
